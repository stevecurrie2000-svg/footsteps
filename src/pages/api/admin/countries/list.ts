...
type CountryRow = {
  ...
  family_thumbnail_photo_id: string | null;
  family_thumbnail_key: string | null;
  photo_count: number;
    ...
    const [countriesResult, citiesResult] = await env.DB.batch([
      env.DB.prepare(`
        SELECT
          ...
          co.family_thumbnail_photo_id,
          ft.r2_key_thumb AS family_thumbnail_key,
        ...
        LEFT JOIN photos ft ON ft.id = co.family_thumbnail_photo_id
